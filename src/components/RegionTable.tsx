...
export default function RegionTable({ regions, latestYear }: Props) {
  ...
  function SortIcon({ k }: { k: SortKey }) {
    if (sortKey !== k) return <span className="text-stone-300 ml-1">↕</span>;
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-wrap gap-3 items-start">
        ...
        <div className="flex flex-col gap-1.5">
          <span className="text-[10px] font-semibold uppercase tracking-widest text-stone-400">시도</span>
        ...
        {/* Type filter */}
        <div className="flex flex-col gap-1.5">
          <span className="text-[10px] font-semibold uppercase tracking-widest text-stone-400">유형</span>
        ...
        <div className="flex flex-col gap-1.5 ml-auto">
          <span className="text-[10px] font-semibold uppercase tracking-widest text-stone-400 text-right">정렬</span>
          <div className="flex gap-1">
            {([
              ["population", "인구"],
              ["fund", "기금"],
      ...
      <p className="text-xs text-stone-400">{filtered.length}개 지역</p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-stone-50 border-b border-stone-200">
              <th className="px-4 py-3 text-left text-xs font-semibold text-stone-500">시도</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-stone-500">시군구</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-stone-500">유형</th>
              <th

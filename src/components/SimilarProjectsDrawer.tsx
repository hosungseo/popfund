    ...
    <>
      ...
      <div
        ...
        className={[
          ...
          "md:inset-y-0 md:left-auto md:right-0 md:w-[480px] md:max-h-none md:h-full md:rounded-none md:border-l md:border-slate-200",
          isOpen
      ...
      >
        ...
        {project && (
          <>
            <div className="shrink-0 border-b border-slate-100 px-5 py-4 flex items-start gap-3">
              <div className="flex-1 min-w-0">
                <p className="text-xs text-slate-500 mb-0.5">{regionName}</p>
            ...
            <div className="flex-1 overflow-y-auto px-5 py-5 flex flex-col gap-6">
              ...
              <section>
                ...
                <div className="bg-slate-50 rounded-lg px-3 py-2.5 mb-3">
                  <p className="text-[10px] text-slate-400 mb-2">재원구성</p>
                  <div className="grid grid-cols-4 gap-1.5">
                    {(
                      ...
                      <div key={label}>
                        ...
                        <p className="font-mono text-[11px] text-slate-700 tabular-nums">
                          {formatWon(value)}
                        </p>
                      </div>
                    ))}
              ...
              <section>
                ...
                {clusterLoading ? (
                  ...
                  <div className="rounded-xl bg-slate-50 border border-dashed border-slate-200 px-5 py-8 text-center">
                  ...
                  <div className="rounded-xl border border-slate-200 overflow-x-auto">
                    <table className="w-full text-xs">
                      ...
                      <tbody className="divide-y divide-slate-100">
                        ...
                        <tr className="bg-[#E8EFF6]/60">
                          <td className="px-3 py-2.5 font-semibold text-[#0B4171] whitespace-nowrap">
                            {regionName}
                            <span className="ml-1.5 inline-flex items-center px-1 py-0.5 rounded text-[9px] font-normal bg-[#0B4171]/10 text-[#0B4171]">
                              현재
                            </span>
                          </td>

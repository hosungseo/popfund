    ...
    <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-sm border-b border-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:h-14 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
        <Link href="/" className="flex items-center gap-2.5 shrink-0 h-11 sm:h-auto">
          <span className="w-2 h-2 rounded-full bg-[#0B4171] shrink-0" />
          <span className="font-bold text-slate-900 text-sm leading-tight whitespace-nowrap">
            지방소멸대응기금 워치
          </span>
        </Link>

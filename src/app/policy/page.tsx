...
export default function PolicyPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col gap-10">
      ...
      {/* Basis info line */}
      <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[11px] font-mono text-stone-400 tabular-nums bg-stone-50 rounded-xl px-4 py-2.5 border border-stone-100">
        <span>
          감소율 구간{" "}
      ...
      {/* Disclaimer */}
      <p className="text-[11px] text-stone-400 border-t border-stone-100 pt-4 leading-relaxed">
